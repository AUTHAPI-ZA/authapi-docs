...
![Webhook](/guides/authapi_settings.png)

### Step 4: Test your webhook

Test your webhook by creating, updating, deleting, verifying, blocking, unblocking, logging in or logging out a user. You should see the data sent by AUTHAPI in your webhook receiver and the data processed by your webhook hander in your webhook hander. If you don't see the data sent by AUTHAPI in your webhook receiver or the data processed by your webhook hander in your webhook hander, check your webhook receiver and webhook hander for errors.
